...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //till now only objects are created DB is not populated
...
//initalise our application with some pre loaded data
//immediately spring boot app is started we populate the database
//run method is executed when application starts